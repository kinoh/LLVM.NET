...
my %defined_in_class = (
	...
	'VendorType' => 'Triple',
	'HandleBaseKind' => 'ValueHandleBase',
	'OtherType' => 'MemDepResult',
	'LegalizeTypeAction' => 'TargetLoweringBase',
	'PassDebuggingString' => 'PMDataManager',
	'MachineOperandType' => 'MCOperand',
	...
	'BlockDisposition' => 'ScalarEvolution',
	...
	'AvailabilityState' => 'TargetLibraryInfo',
	...
	'BufferKind' => 'raw_ostream',
	'ProtectionFlags' => 'Memory',
	'VisibilityTypes' => 'GlobalValue',
	'FunctionLocalness' => 'MDNode',
	'AttrKind' => 'Attribute',
...
my %defined_in = (
	...
	'SUnitIterator' => 'llvm/CodeGen/ScheduleDAG.h',
	...
	'SCEVTruncateExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	'DbgInfoIntrinsic' => 'llvm/IR/IntrinsicInst.h',
	...
	'MemTransferInst' => 'llvm/IR/IntrinsicInst.h',
	...
	'RegistryTraits' => 'llvm/Support/Registry.h',
	'DIVariable' => 'llvm/DebugInfo.h',
	...
	'ConnectedVNInfoEqClasses' => 'llvm/CodeGen/LiveInterval.h',
	...
	'PBQPBuilder' => 'llvm/CodeGen/RegAllocPBQP.h',
	'Pass' => 'llvm/Pass.h',
	'ICmpInst' => 'llvm/IR/Instructions.h',
	'Loop' => 'llvm/Analysis/LoopInfo.h',
	'DITemplateValueParameter' => 'llvm/DebugInfo.h',
	'MCDwarfFrameEmitter' => 'llvm/MC/MCDwarf.h',
	...
	'DIObjCProperty' => 'llvm/DebugInfo.h',
	...
	'SCEVCastExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	'PointerUnion4' => 'llvm/ADT/PointerUnion.h',
	...
	'DITemplateTypeParameter' => 'llvm/DebugInfo.h',
	...
	'DiffStateMachine' => 'llvm/Support/IntegersSubsetMapping.h',
	'MCSubtargetInfo' => 'llvm/MC/MCSubtargetInfo.h',
	'FPToUIInst' => 'llvm/IR/Instructions.h',
	'ConstIterator' => 'llvm/ADT/DenseSet.h',
	...
	'DIEnumerator' => 'llvm/DebugInfo.h',
	'DbgValueInst' => 'llvm/IR/IntrinsicInst.h',
	...
	'VACopyInst' => 'llvm/IR/IntrinsicInst.h',
	'SCEVUnknown' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	...
	'BackedgeTakenInfo' => 'llvm/Analysis/ScalarEvolution.h',
	...
	'LiveInterval' => 'llvm/CodeGen/LiveInterval.h',
	...
	'HeuristicSolver' => 'llvm/CodeGen/PBQP/HeuristicSolver.h',
	...
	'listener' => 'llvm/Support/Registry.h',
	...
	'Constraint' => 'llvm/Analysis/DependenceAnalysis.h',
	...
	'MCLineSection' => 'llvm/MC/MCDwarf.h',
	...
	'FullDependence' => 'llvm/Analysis/DependenceAnalysis.h',
	...
	'Array' => 'llvm/CodeGen/LiveIntervalUnion.h',
	...
	'EdgeItrCompartor' => 'llvm/CodeGen/PBQP/Graph.h',
	...
	'ThreadLocal' => 'llvm/Support/ThreadLocal.h',
	...
	'child_iterator' => 'llvm/Object/Archive.h',
	...
	'SCEVUDivExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	...
	'MemIntrinsic' => 'llvm/IR/IntrinsicInst.h',
	'Path' => 'llvm/Support/PathV1.h',
	...
	'ScheduleDAGTopologicalSort' => 'llvm/CodeGen/ScheduleDAG.h',
	'MallocAllocator' => 'llvm/Support/Allocator.h',
	'DIArray' => 'llvm/DebugInfo.h',
	...
	'EmptyHNode' => 'llvm/Support/YAMLTraits.h',
	'DIFile' => 'llvm/DebugInfo.h',
	...
	'DILexicalBlockFile' => 'llvm/DebugInfo.h',
	'self_process' => 'llvm/Support/Process.h',
	'ScalarEvolution' => 'llvm/Analysis/ScalarEvolution.h',
	...
	'DependenceAnalysis' => 'llvm/Analysis/DependenceAnalysis.h',
	'StringMap' => 'llvm/ADT/StringMap.h',
	'Interval' => 'llvm/Analysis/Interval.h',
	'MutableArrayRef' => 'llvm/ADT/ArrayRef.h',
	...
	'DebugInfoFinder' => 'llvm/DebugInfo.h',
	'SmartScopedLock' => 'llvm/Support/Mutex.h',
	'FileInfo' => 'llvm/Support/GCOV.h',
	'AsmToken' => 'llvm/MC/MCParser/MCAsmLexer.h',
	'LiveRangeUpdater' => 'llvm/CodeGen/LiveInterval.h',
	'MCLineEntry' => 'llvm/MC/MCDwarf.h',
	...
	'VersionMapEntry' => 'llvm/Object/ELF.h',
	'GCFunctionInfo' => 'llvm/CodeGen/GCMetadata.h',
	'SlotIndex' => 'llvm/CodeGen/SlotIndexes.h',
	...
	'MemoryDependenceAnalysis' => 'llvm/Analysis/MemoryDependenceAnalysis.h',
	'Trace' => 'llvm/CodeGen/MachineTraceMetrics.h',
	'LibCallInfo' => 'llvm/Analysis/LibCallSemantics.h',
	'ilist_half_node' => 'llvm/ADT/ilist_node.h',
	'StringMapIterator' => 'llvm/ADT/StringMap.h',
	'MapHNode' => 'llvm/Support/YAMLTraits.h',
	...
	'PrettyStackTraceString' => 'llvm/Support/PrettyStackTrace.h',
	...
	'MCAsmInfoMicrosoft' => 'llvm/MC/MCAsmInfoCOFF.h',
	...
	'MemSetInst' => 'llvm/IR/IntrinsicInst.h',
	...
	'NonLocalDepResult' => 'llvm/Analysis/MemoryDependenceAnalysis.h',
	...
	'DIDerivedType' => 'llvm/DebugInfo.h',
	'MachineSchedRegistry' => 'llvm/CodeGen/MachineScheduler.h',
	'PBQPBuilderWithCoalescing' => 'llvm/CodeGen/RegAllocPBQP.h',
	...
	'SpillCostComparator' => 'llvm/CodeGen/PBQP/Heuristics/Briggs.h',
	...
	'EdgeData' => 'llvm/CodeGen/PBQP/HeuristicSolver.h',
	'Attribute' => 'llvm/IR/Attributes.h',
	'IntEqClasses' => 'llvm/ADT/IntEqClasses.h',
	'PooledStringPtr' => 'llvm/Support/StringPool.h',
	...
	'MachineModuleInfoELF' => 'llvm/CodeGen/MachineModuleInfoImpls.h',
	...
	'Ensemble' => 'llvm/CodeGen/MachineTraceMetrics.h',
	'ConstMIOperands' => 'llvm/CodeGen/MachineInstrBundle.h',
	'DIScope' => 'llvm/DebugInfo.h',
	'MemCpyInst' => 'llvm/IR/IntrinsicInst.h',
	...
	'SCEVSignExtendExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	...
	'PointerUnion3' => 'llvm/ADT/PointerUnion.h',
	...
	'FixedStackPseudoSourceValue' => 'llvm/CodeGen/PseudoSourceValue.h',
	'Registry' => 'llvm/Support/Registry.h',
	...
	'MCDwarfFileTable' => 'llvm/MC/MCDwarf.h',
	...
	'PrettyStackTraceProgram' => 'llvm/Support/PrettyStackTrace.h',
	'MCSubRegIterator' => 'llvm/MC/MCRegisterInfo.h',
	'MCTargetExpr' => 'llvm/MC/MCExpr.h',
	'SCEVUMaxExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	'FoldingSetNodeWrapper' => 'llvm/ADT/FoldingSet.h',
	'PointerUnion' => 'llvm/ADT/PointerUnion.h',
	...
	'DbgDeclareInst' => 'llvm/IR/IntrinsicInst.h',
	'MIOperands' => 'llvm/CodeGen/MachineInstrBundle.h',
	'MCGenDwarfLabelEntry' => 'llvm/MC/MCDwarf.h',
	'PointerType' => 'llvm/IR/DerivedTypes.h',
	'IntToPtrInst' => 'llvm/IR/Instructions.h',
	'SmartMutex' => 'llvm/Support/Mutex.h',
	'RNSuccIterator' => 'llvm/Analysis/RegionIterator.h',
	'Capacity' => 'llvm/Support/ArrayRecycler.h',
	'DISubrange' => 'llvm/DebugInfo.h',
	...
	'SCEVZeroExtendExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	...
	'VAEndInst' => 'llvm/IR/IntrinsicInst.h',
	'FindUsedTypes' => 'llvm/Analysis/FindUsedTypes.h',
	'member_iterator' => 'llvm/ADT/EquivalenceClasses.h',
	...
	'MCDwarfLoc' => 'llvm/MC/MCDwarf.h',
	'GCModuleInfo' => 'llvm/CodeGen/GCMetadata.h',
	...
	'ScalarHNode' => 'llvm/Support/YAMLTraits.h',
	...
	'SCEVAddRecExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
	'SmartRWMutex' => 'llvm/Support/RWMutex.h',
	'MCFixup' => 'llvm/MC/MCFixup.h',
	'Optional' => 'llvm/ADT/Optional.h',
	'iterator_base' => 'llvm/ADT/SparseMultiSet.h',
	...
	'RefCountedBaseVPTR' => 'llvm/ADT/IntrusiveRefCntPtr.h',
	...
	'NonLocalDepEntry' => 'llvm/Analysis/MemoryDependenceAnalysis.h',
	...
	'symbol_iterator' => 'llvm/Object/Archive.h',
	'SCEVMulExpr' => 'llvm/Analysis/ScalarEvolutionExpressions.h',
...
EOF
	...
	if (($args[$#args] =~ /^(SmallVectorImpl<\w+>)\s+&\w+$/))
	{
		pop @args;
		$type = $1;
		$return_by_ptr = 1;
